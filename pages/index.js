...
export default function Home() {
    ...
    return (
        <>
            ...
            {/* Hero Section with CRYSTAL CLEAR Video Background */}
            <section className="relative h-[600px] md:h-[700px] overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <video
                        ...
                        style={{filter: 'brightness(0.9)'}} // Slight brightness adjustment
                    >
                        {/* High quality video sources - MP4 first for best compatibility */}
              ...
              <span
                  className="bg-accent text-primary px-4 py-2 rounded-full text-sm font-bold inline-block mb-6 shadow-lg">
                INTEGRATED ENGINEERING & PROJECT ADVISORY
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="/contact" className="btn-primary text-center shadow-lg hover:shadow-xl">Partner
                                With Us</Link>
                            <Link href="/projects" className="btn-secondary text-center shadow-lg hover:shadow-xl">View
                                Our Projects</Link>
                        </div>
                    </div>
                </div>
            ...
            {/* Company Overview, Services, Mission & Vision, Featured Projects, CTA, Footer */}
            {/* ... keep all the existing code below as is ... */}
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-gray-600">
                                <p>
                                    In an environment defined by complexity, capital intensity, and heightened
                                    stakeholder expectations,
                                    successful infrastructure delivery demands structured decision-making, strong
                                    governance, and disciplined
                                    execution. We are not a conventional design consultancy—we are a project advisory
                                    and engineering management
                                    firm that partners with clients from project inception through commissioning and
                                    handover.
                                </p>
                                <p>
                                    Founded on extensive experience in civil and structural engineering, project
                                    management, and industrial
                                    project execution, our role extends far beyond producing drawings. We support
                                    clients and developers at
                                    every stage of the project lifecycle.
                                </p>
                            </div>
                            <Link href="/about" className="inline-flex items-center text-primary font-bold mt-6 group">
                                Learn More About Us
                                <svg className="w-5 h-5 ml-2 group-hover:translate-x-2 transition" fill="none"
                        ...
                        {[
                            ...
                            <div key={i}
                                ...
                                <div className="relative h-48">
                                    ...
                                    />
                                    <div
                                        className="absolute inset-0 bg-primary/40 group-hover:bg-primary/20 transition"></div>
                                </div>
                                <div className="p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-white">
                        <div className="backdrop-blur-sm bg-white/10 p-8 rounded-2xl border border-white/20">
                            ...
                            <p className="text-lg leading-relaxed">
                                To be a leading multidisciplinary engineering and consulting firm, recognized for
                                delivering sustainable,
                                innovative, and high-value infrastructure through integrated expertise and disciplined
                                execution.
                            </p>
                        </div>
                        <div className="backdrop-blur-sm bg-white/10 p-8 rounded-2xl border border-white/20">
                            ...
                            <p className="text-lg leading-relaxed">
                                To provide end-to-end infrastructure solutions by seamlessly combining architecture,
                                engineering, and
                                project management—driving efficiency, technical excellence, and measurable long-term
                                value for clients
                                and communities.
                            </p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="group relative h-80 rounded-xl overflow-hidden shadow-xl">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-primary via-primary/50 to-transparent opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                <div
                                    className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition duration-500">
            ...
            <section className="bg-accent py-16">
                <div className="container-custom text-center">
                    ...
                    <p className="text-xl text-primary/80 mb-8 max-w-2xl mx-auto">
                        Partner with us for insight-led execution, accountability, and excellence in end-to-end project
                        delivery.
                    </p>
                    <Link href="/contact"
                          className="bg-primary text-white font-bold py-4 px-8 rounded-lg hover:bg-primary/90 transition inline-block shadow-lg">
                        Get In Touch Today
                    </Link>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Link href="/about" className="text-gray-300 hover:text-accent transition">About
                                    Us</Link></li>
                                <li><Link href="/team" className="text-gray-300 hover:text-accent transition">Our
                                    Team</Link></li>
                                <li><Link href="/projects"
                                          className="text-gray-300 hover:text-accent transition">Projects</Link></li>
                                <li><Link href="/contact"
                                          className="text-gray-300 hover:text-accent transition">Contact</Link></li>
                            </ul>
                        </div>
                    </div>
