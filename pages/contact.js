          ...
          <div className="container-custom py-3">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden md:flex space-x-6 lg:space-x-8">
                ...
                <Link href="/contact" className="text-accent transition font-medium text-sm lg:text-base">Contact</Link>
              </div>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden mt-4 pb-4 space-y-3 bg-primary/90 rounded-lg p-4">
                  ...
                  <Link href="/contact" className="block text-accent transition py-2">Contact</Link>
                </div>
            )}
          </div>
        </nav>
